...
- The customer screen may show public-source indicative ocean freight ranges as a pre-booking estimate only. These estimates can move up or down at actual booking.
