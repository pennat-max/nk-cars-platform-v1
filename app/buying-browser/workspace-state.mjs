...
function customerControlledCase(caseRecord, currentCase) {
  if (currentCase?.ownerVerification?.status === "Owner Verified") {
    return {
      ...
      shippingDestinationCountry: currentCase.shippingDestinationCountry ?? null,
      shippingDestinationPort: currentCase.shippingDestinationPort ?? null,
      shippingVehicleQuantity: currentCase.shippingVehicleQuantity ?? 1,
      shippingContainerLoadingFeeThb: currentCase.shippingContainerLoadingFeeThb ?? null,
