  ...
  return (
    <>
      ...
      <section className="bb-ai-search-tool">
        ...
        <p className="bb-ai-boundary"><Info size={14} />{sourceStatus.live ? "Results use the approved Google Sheet and customer-safe Google Drive media." : "Google synchronization is unavailable. Results use the last verified NK snapshot and never invent current availability."}</p>
      </section>
