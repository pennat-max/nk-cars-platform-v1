...
const seeds: CaptureSeed[] = [
  ...
  },
  {
    ...
    internalNotes: "Seller states one-owner history and Ironman suspension. Mileage was not available in the captured facts. Raw media remains Owner-only.",
    title: "2020 Toyota Hilux Revo 2.8 4WD MT Single Cab",
    summary: "A grey 2020 Hilux Revo single cab with a claimed 2.8L diesel engine, manual transmission, and 4WD. Mileage, availability, modifications, and condition require NK verification.",
    brand: "Toyota", model: "Hilux Revo", year: 2020, grade: "Unknown", engine: "2.8L diesel",
    transmission: "MT", drive: "4WD", body: "Single Cab", mileageKm: null, color: "Grey",
    observedPriceThb: 599000, observedAt: "2026-08-25T15:51:03.222Z", generalLocation: "Surat Thani",
    translationState: "Need Review", evidenceLabels: ["Listing title", "Listing description", "Mileage unavailable"],
  },
  {
