...
test("account workspace validation enforces ownership and customer-safe fields", () => {
  ...
  assert.deepEqual(workspaceSummary(owned), { savedVehicles: 1, vehicleCases: 1, importedListings: 1, sourceCaptures: 0, wantedRequests: 0, conversionEvents: 0, messages: 1 });
...
test("renders additive Buying Browser routes without customer source leakage", async () => {
  ...
  const ctx = { waitUntil() {}, passThroughOnException() {} };
  const routes = ["/buy", "/buy/browser", "/buy/browse", "/buy/saved", "/buy/shipments", "/buy/paste", "/buy/share", "/buy/ask", "/buy/cases", "/buy/cases/NK-CASE-2026-000001", "/buy/cases/NK-CASE-2026-000001/pi", "/buy/inspections", "/buy/messages", "/buy/account", "/buy/vehicle/nk-market-2026-0825-01", "/buy/vehicle/nk-market-2026-0825-05"];
  for (const route of routes) {
    ...
    if (route === "/buy") {
      ...
      assert.match(textHtml, /<b>65<\/b> vehicles/i);
